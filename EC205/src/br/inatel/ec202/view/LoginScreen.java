...
import br.inatel.ec202.control.UnknownUserException;
...
public class LoginScreen extends JFrame 
{
	...
	private void signIn() throws UnknownUserException
	{
		...
		if (username.equals("admin") && password.equals("admin")) Controller.openAdminScreen();
		else if (Controller.findUser(username, password)) Controller.openUserScreen();
