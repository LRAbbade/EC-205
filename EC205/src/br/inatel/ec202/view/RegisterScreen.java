package br.inatel.ec202.view;
import java.awt.BorderLayout;
import javax.swing.JFrame;
import javax.swing.JPanel;
import javax.swing.border.EmptyBorder;

import br.inatel.ec202.control.Controller;
import br.inatel.ec202.control.InvalidPasswordException;
import br.inatel.ec202.control.InvalidUsernameException;
import br.inatel.ec202.control.UserAlreadyRegisteredException;
...
public class RegisterScreen extends JFrame 
{
	...
	private void returnEdittedUser() 
	{
		 ...
		 Controller.returnEdittedUser(beingEditted);
	}
	...
	private boolean signUp() throws InvalidPasswordException, InvalidUsernameException
	{
		...
		if (Controller.findUser(username, password)) return false;
		...
		try {
			...
			Controller.registerUser(u.getPersonalId(), u); 
